...
class Zefoy:
	...
	def find_video(self):
		...
		while True:
			...
			if 'Session expired. Please re-login' in self.video_info: print('</> Phiên hết hạn. Đang đăng nhập lại...');self.send_captcha(); return
				...
				# print(f'</> Thời gian chờ để tiếp tục tăng: {t} giây')
				# for lam in range(t,0,-1):
				# 	lam-=1
				# 	print(f"</> Vui lòng chờ: {lam}",end="\r")
				# 	time.sleep(1)
				_=time.time()
	...
	def use_service(self):
		...
		if 'Session expired. Please re-login' in res: print('</> Phiên hết hạn. Đang đăng nhập lại...');self.send_captcha(); return ""
	...
	def get_video_id(self, url_ = None, set_url=True):
		...
		if request.text == '': print('</> Link video không hợ lệ'); return False
	...
	def update_name(self):
		while True:
			try:
				...
				self.text = f"[×_×] | Views: {video_info['viewCount']} "
			except: pass
			time.sleep(5)
trang = "\033[1;37m"
xanh_la = "\033[1;32m"
...
{xanh_duong}             ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝
    ...
    {xanh_la} [×_×] Tool Độc Quyền Của 🌺 HDT - TOOL 🌺
    \033[1;34m⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦
    {do}[{trang}{kt_code}{do}] {vang}TOOL BUFF VIEW TIKTOK 
    {do}[{trang}{kt_code}{do}] \033[1;35mADMIN:\033[1;36m 🌺 HDT -TOOL 🌺
    {do}[{trang}{kt_code}{do}] \033[1;31mNHÓM ZALO: \033[1;33m https://zalo.me/g/bprmyn080
    {do}[{trang}{kt_code}{do}] {dac_biet}YOUTUBE:\033[1;37m https://youtube.com/@HDTTOOL
    {do}[{trang}{kt_code}{do}] {xanh_la}WEB:\033[1;37m linkbio.co/hdttool
    \033[1;34m⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦\n"""
...
if 1:
    ...
    print(f"{do}Bạn Làm Con Cặc Gì Vậy")
    exit()
